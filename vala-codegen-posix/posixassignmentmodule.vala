 ...
 */
public class Vala.CodeGen.PosixAssignmentModule : Vala.CodeGen.PosixMemberAccessModule {
	...
	public override void store_parameter (Parameter param, TargetValue value, bool capturing_parameter = false) {
